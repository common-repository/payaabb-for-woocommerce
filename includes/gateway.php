...
class WC_Payaabb_Gateway extends WC_Payment_Gateway
{
    /**
     * API access key
     *
    ...
    public function __construct()
    {
        ...
        $this->method_description = sprintf(
            ...
            '<a href="https://auth.payaabb.com/sign-up-merchant" target="_blank">Sign up</a>'
        );
    ...
    public function process_payment($order_id)
    {
        ...
        $request = wp_remote_get(
            "https://public.payaabb.com/create-token?price=" .
                $order->get_total() .
                "&orderId=" .
                $order_id .
                "&code=" .
        ...
        if (isset($response->payToken)) {
            ...
            $order->update_status(
                "on-hold",
                esc_html__("Awaiting crypto payment", "payaabb-for-woocommerce")
            );
            ...
            return [
                "result" => "success",
                "redirect" => "https://checkout.payaabb.com/a/$app_code?token=$token&returnUrl=$return_url",
            ];
        }

        wc_add_notice(
            esc_html__("Error pay token", "payaabb-for-woocommerce"),
            "error"
        );
        return [
            "result" => "failure",
